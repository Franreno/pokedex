export async function findEvolutionChainArray(evolutionChain, evolutionChainPokemons){
    evolutionChainPokemons.push(await getPokemonInChain(evolutionChain));
    console.log(evolutionChainPokemons[evolutionChainPokemons.length-1].name, evolutionChainPokemons.length);
    if(evolutionChain.evolves_to.length!==0){
        for(let i = 0; i<evolutionChain.evolves_to.length; i++){
            await findEvolutionChainArray(evolutionChain.evolves_to[i], evolutionChainPokemons);
        }
    }
}

export async function getPokemonInChain(evolutionChain){
    let res;
